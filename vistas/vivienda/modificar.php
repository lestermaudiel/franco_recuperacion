...
<div class="container">
    ...
    <div class="row justify-content-center">
        <form action="/franco_recuperacion/controladores/vivienda/guardar.php" method="POST" class="col-lg-8 border bg-light p-3">
            <input type="hidden" name="vivienda_id" value="<?= $vivienda['vivienda_id'] ?>">
            <div class="row mb-3">
                <div class="col">
                    <label for="vivienda_residente">Nombre del Residente</label>
                    <input type="text" name="vivienda_residente" id="vivienda_residente" class="form-control" value="<?= $vivienda['vivienda_residente'] ?>" required>
                </div>
            </div>
            <div class="row mb-3">
                <div class="col">
                    ...
                    <select name="vivienda_condominio_id" id="vivienda_condominio_id" class="form-control">
                        ...
                        <?php foreach ($condominio as $cond) : ?>
                            <option value="<?= $cond['condominio_id'] ?>" <?= ($cond['condominio_id'] == $vivienda['vivienda_condominio_id']) ? 'selected' : '' ?>>
                                <?= $cond['condominio_nombre'] ?>
                            </option>
                        <?php endforeach ?>
                    </select>
                </div>
